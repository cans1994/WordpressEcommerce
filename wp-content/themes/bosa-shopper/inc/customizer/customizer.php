...
function bosa_shopper_kirki_fields(){
	...
	*/
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Image Size', 'bosa-shopper' ),
		'type'        => 'select',
		'settings'    => 'render_header_ad_image_size',
		'section'     => 'header_style_options',
		'default'     => 'full',
		'placeholder' => esc_html__( 'Select Image Size', 'bosa-shopper' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Image Size', 'bosa-shopper' ),
		'description' => esc_html__( 'Image Size for thumbnail post only.', 'bosa-shopper' ),
		'type'        => 'select',
